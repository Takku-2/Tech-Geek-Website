...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	$create_query="CREATE TABLE IF NOT EXISTS project.register (Usename VARCHAR(255) NOT NULL UNIQUE,Password VARCHAR(255) NOT NULL ,Phoneno VARCHAR(255) NOT NULL,Email TEXT NOT NULL ,Country TEXT NOT NULL ,Gender TEXT NOT NULL,Address TEXT NOT NULL )";
	$result1=mysqli_query($conn,$create_query);
	if($result1){
		
	 } else{
	     echo "ERROR: Could not able execute " . mysqli_error($conn);
...
if(mysqli_query($conn, $sql)){
    echo "Records inserted successfully.";
		...
		header('Location:http://localhost/C107_Website_Project/Website%20Project/index.php');
} else{
